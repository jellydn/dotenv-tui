...
// Returns list of .env.example file paths relative to root.
...
// isExampleFile checks if a filename matches .env.example patterns
func isExampleFile(fileName string) bool {
	// Match .env.example or .env.*.example
